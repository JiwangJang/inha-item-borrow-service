...
class LoginServiceTest {
    ...
    void setUp() {
        ...
        loginService = new LoginService(borrowerCache, tempBorrowerCache, borrowerRepository);
    }
    ...
    void inhaLogin_Success_NewUser() throws IOException {
        ...
        try (MockedStatic<Jsoup> jsoupMock = mockStatic(Jsoup.class)) {
            ...
            given(connection.data(anyString(), anyString(), anyString(), anyString())).willReturn(connection);
            ...
            given(document.select(".user-info-picture .department")).willReturn(deptElements);
            ...
            doThrow(new ResourceNotFoundException(errorCode.name(),errorCode.getMessage()))
            ...
            verify(tempBorrowerCache, times(1)).put(eq(testId), any(BorrowerInformDto.class));
        }
    }

...
class SignUpRequestServiceTest {
    ...
    void failedPatchSignUpRequestNotFound(){
        ...
        assertThatThrownBy(()->signUpRequestService.patchSignUpRequest(signUpForm,idCard,councilFee,"123","123"))
    ...
    void failedPatchSignUpIncorrectPassword(){
        ...
        assertThatThrownBy(()->signUpRequestService.patchSignUpRequest(signUpForm,idCard,councilFee,"123","321"))
                .isInstanceOf(InvalidValueException.class)
    ...
    void print() {
        ...
        System.out.println("S3Service inside SignUpRequestService: " + ReflectionTestUtils.getField(signUpRequestService, "s3Service"));
    }
}

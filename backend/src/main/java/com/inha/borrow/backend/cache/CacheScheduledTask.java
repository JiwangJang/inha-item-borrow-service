...
public class CacheScheduledTask {
    ...
    public void refreshBorrowerCache(String borrowerId){
        CacheBorrowerDto dtoList = borrowerRepository.findByIdWithFeeVerification(borrowerId);
        borrowerCache.put(borrowerId,dtoList);
    }
}
